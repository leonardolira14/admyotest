...
$(document).on('click','div[llc="btnf"]',function(){
	...
	ayuda.senddata(obt,"<?=base_URL()?>/calificaciones/CalificacionesBruto",function(data){
		...
		for(key in calificaciones){
			...
			cade+='<div class="row">';
			cade+='<i class="fa fa-eye bgblue-1 white iconos_botones link" llc="<?= base_URL()?>PerfilBuscado/perfil/'+lin.calificaciones[key].num_empresa_receptora+'" data-toggle="popover" title="Visitar Perfil" data-original-title="" aria-describedby="popover618033"></i>';
...
<div class="container-fluid">
	<div class="row banner ">
		<div class="bg"></div>
		<div class="text">
			CALIFICACIONES REALIZADAS A PROVEEDORES
		</div>
...
<div class="container margin-top-30 menu-tab">
	<div class="row">
		...
		<a href="<?= base_URL()?>resumenproveedor" class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4  text-center link" >
			<div class="tab ">
				<i class="fa fa-line-chart ibtn bgblue-1 white"></i>
				RESUMEN
			</div>
		</a>
		<a href="<?= base_URL()?>listaproveedores" class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4  text-center link" >
			<div class="tab ">
				<i class="fa fa-users ibtn bgblue-1 white"></i>
				MIS PROVEEDORES
			</div>
		</a>
		<a href="<?= base_URL()?>realizadasproveedores" class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4  text-center link" >
					...
					if($calificaciones!=false){
						foreach ($calificaciones as $key) {
							...
							<div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 centrar-vertical-contend" id="acciones-cal">
								<div class="row">
									<i class="fa fa-eye bgblue-1 white iconos_botones link" llc="<?= base_URL()?>/PerfilBuscado/perfil/<?=$key['num_empresa_receptora'] ?>" data-toggle="popover" title="Visitar Perfil" data-original-title="" aria-describedby="popover618033"></i>
...
<div id="mensaje-Pendientea" class="izimodal" width="700" data-title="Mensaje de Admyo">
	<div class="container">
		<div class="row">
		<div class="col-12">
			<label for="">Este Proveedor ha solicitado la anulación de esta Calificación, por motivos de no tener relación alguna, para demostrar lo contrario por favor háganos llegar la siguiente documentación a info@admyo.con con el asunto: “No Anulación de Calificación” seguido de la Razon Social de su empresa.</label>
