						...
						if($calificaciones!=false){
							foreach ($calificaciones as $key) {
								...
								<div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-7" id="Texto-cal">
									<? if($key->Status_Valora=="PendienteA"){
										$status="Pendinete de Anulación";
										$icon="fa-ban";
										$leyenda="Pendiente de Anulación";
										$llc="";
								...
								<div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 centrar-vertical-contend" id="acciones-cal">
									<div class="row">
										...
										<i class="fa fa-search bgblue-1 white iconos_botones" lld="detalleva" llc="<?= $key->IDValora?>" data-toggle="popover" title="" data-original-title="Ver Detalles" aria-describedby="popover618033"></i>

										<i class="fa <?= $icon;  ?> bgblue-1 white iconos_botones" lld="invisble-empre" llc="<?= $key->IDValora?>" <?=$llc?> data-toggle="popover" title="" data-original-title="<?= $leyenda;  ?>" aria-describedby="popover618033"></i>
									</div>
								</div>
