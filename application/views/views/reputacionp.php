<div class="container margin-top-30">
	<div class="row">
		<div class=" col-12 titulos  text-center margin-bottom-30"><h4><strong>REPUTACIÓN DE MIS PROVEEDORES</strong></h4></div>
	</div>
</div>
...
<script>
	$(function(){
		...
		ayuda.senddata(obt,"/Clientes/RepClientesporAnio",function(data){
			...
			ayuda.graficar('g1',"Reputación de Proveedores /"+lin.anio,'Numero de Clientes',lin.clientes.reputacion,lin.clientes.Catego);
