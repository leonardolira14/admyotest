<div class="container margin-top-30">
	<div class="row">
		<div class=" col-12 titulos  text-center margin-bottom-30"><h4><strong>CALIFICACIONES REALIZADAS DE CLIENTES</strong></h4></div>
		<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4  text-center link" llc="/perfil/calificacionesrealizadasc">
			<div class="tab ">
				<i class="fa fa-line-chart ibtn bgblue-1 white"></i>
				TOTALES
			</div>
		</div>
		<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4  text-center link" llc="/perfil/RecibidasClientes">
			<div class="tab current">
				<i class="fa fa-users ibtn bgblue-1 white"></i>
				CLIENTES
			</div>
		</div>
		<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4  text-center link" llc="/perfil/realizadasclientestotal">
			<div class="tab ">
...
<div class="container margin-top-30">
	<div class="tables">
		<div class=" col-12  thead titulos-blanco  text-center margin-bottom-30"><h4><strong>GESTIÓN DE CLIENTES</strong></h4></div>
