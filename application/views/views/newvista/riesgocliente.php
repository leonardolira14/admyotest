			 ...
			 if(isset($perfilbuscado)){
				...
				<div class="text">
			 	...
			 	if($tip==="M"){
			  	...
			  	?>
					<h4>El Riesgo por la reputación de los clientes de</h4>
					<h3><?= $datosperfil->Razon_Social?></h3>
					<h5>basado en las calificaciones recibidas de sus clientes en un mes.</h5>
				<?
				}
				else{
					?>
					<h4>El Riesgo por la reputación de los clientes de</h4>
					<h3><?= $datosperfil->Razon_Social?></h3>
					<h5>basado en las calificaciones recibidas de los clientes en 12 meses.</h5>
					<?
				}
			 }else{
			 	?>
				...
				<div class="text">
			 	...
			 	if($tip==="M"){
			  	?>
				Tu Riesgo por la reputación de tus clientes
				<br>
				<h5>basado en las calificaciones recibidas de tus clientes en un mes.</h5>
				<?
				}
				else{
					?>
					Tu Riesgo por la reputación de tus clientes
					<br>
					<h5>basado en las calificaciones recibidas de tus clientes en 12 meses.</h5>
					<?
				}
			 }
...
<div class="container m-t-20 img-perfil">
 	<div class="row">
 		<div class="col-4">
 			<div class="card w-80" >
 		...
 		<div class="col-6 text-right">
 			<div class="btn-group" role="group" aria-label="Basic example">
			  ...
			  <?
			   ...
			   {
			   	?>
					<a href="<?=base_URL()?>perfildetallesriesgo/cliente/<?= $tip?>/<?= $datosperfil->IDEmpresa?>" class="btn btn-primary">Ver Detalles</a>
			   	<?
			   	if($tip==="M"){
			  		?>
			  		
			  		<a href="<?=base_URL()?>perfilriesgoclientes/M/<?= $datosperfil->IDEmpresa?>"  class="btn btn-primary active">MES</a>
			  		<a href="<?=base_URL()?>perfilriesgoclientes/A/<?= $datosperfil->IDEmpresa?>" class="btn btn-secondary ">12 MESES</a>
			  		<?
			  	}else{
			  		?>
			  		
					<a href="<?=base_URL()?>perfilriesgoclientes/M/<?= $datosperfil->IDEmpresa?>"  class="btn btn-secondary ">MES</a>
			  		<a href="<?=base_URL()?>perfilriesgoclientes/A/<?= $datosperfil->IDEmpresa?>" class="btn btn-primary active">12 MESES</a>
			  		<?
			   }
			   ...
			   {
			   	?>
			   	<a href="<?=base_URL()?>detallesriesgo/cliente/<?= $tip?>" class="btn btn-primary">Ver Detalles</a>
			   <?
			   	if($tip==="M"){
			  		?>
			  		
			  		<a href="<?=base_URL()?>riesgocliente/M"  class="btn btn-primary active">MES</a>
			  		<a href="<?=base_URL()?>riesgocliente/A" class="btn btn-secondary ">12 MESES</a>
			  		<?
			  	}else{
			  		?>
			  		
					<a href="<?=base_URL()?>riesgocliente/M"  class="btn btn-secondary ">MES</a>
			  		<a href="<?=base_URL()?>riesgocliente/A" class="btn btn-primary active">12 MESES</a>
			  		<?
			   }
