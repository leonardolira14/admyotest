...
<div class="container-fluid">
	<div class="row banner ">
		<div class="bg"></div>
		<div class="text">
			Resumen de calificaciones realizadas a mis clientes
		</div>
...
<div class="container-fluid ">
	<div class="row m-t-40">
		<div class="col-6 titulo text-center">
			Media de Clientes calificados en el último trimestre
		</div>
		<div class="col-6 titulo">Número de Clientes Registrados</div>
	</div>
	...
	<div class="row">
		<div class="col-12 titulo">
			Número de calificaciones realizadas a Clientes
		</div>
		<div class="col-12">
	...
	<div class="row m-t-80">
		<div class="col-12 titulo">
			Promedio en número de calificaciones realizadas por cliente
		</div>
		<div class="col-12">
