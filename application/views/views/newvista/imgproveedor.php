	...
	<div class="row banner ">
		<?
				if(isset($perfilbuscado)){
					...
					<div class="bg-b"></div>
					<div class="text">
						<h4>La Imagen Como proveedor de</h4>
					...
					<div class="bg"></div>
					<div class="text">
					Tu Imagen Como proveedor
					<br>
					
					<?
				}
			?>
			<h5>basado en calificaciones de clientes en <?=$label?>.</h5> 
		</div>
...
<div class="container ">
 			...
 			<div class="btn-group" role="group" aria-label="Basic example">
			  ...
			  <?
			  		...
			  		if(isset($perfilbuscado)){
			  			if($tip==="M"){
			  				?>
			  				<a href="<?=base_URL()?>perfilimgproveedor/M/<?=$datosperfil->IDEmpresa ?>"  class="btn btn-primary active">MES</a>
			  				<a href="<?=base_URL()?>perfilimgproveedor/A/<?=$datosperfil->IDEmpresa ?>" class="btn btn-secondary ">12 MESES</a>
			  				<?
			  			}else{
			  				?>
			  				<a href="<?=base_URL()?>perfilimgproveedor/M/<?=$datosperfil->IDEmpresa ?>"  class="btn btn-secondary ">MES</a>
			  				<a href="<?=base_URL()?>perfilimgproveedor/A/<?=$datosperfil->IDEmpresa ?>" class="btn btn-primary active">12 MESES</a>
			  				<?
			  			}
			  		}else{
			  			if($tip==="M"){
			  				?>
			  				<a href="<?=base_URL()?>ImgProveedor/M"  class="btn btn-primary active">MES</a>
			  				<a href="<?=base_URL()?>ImgProveedor/A" class="btn btn-secondary ">12 MESES</a>
			  				<?
			  			}else{
			  				?>
			  				<a href="<?=base_URL()?>ImgProveedor/M"  class="btn btn-secondary ">MES</a>
			  				<a href="<?=base_URL()?>ImgProveedor/A" class="btn btn-primary active">12 MESES</a>
			  				<?
			  			}
			  		}
			  		?>
			    ...
			    <div class="container-fluid">
			    	<div class="row">
			    		...
			    		<div class="col-12">
			    			...
			    			if(isset($perfilbuscado)){
			    				?>
			    				<a href="<?= base_URL('perfildetallesimagen/Proveedor/'.$tip.'/'.$datosperfil->IDEmpresa)?>" class="btn btn-primary">
			    				<?
			    			}else{
			    				?>
			    				<a href="<?= base_URL('detallesimagen/Proveedor/').$tip?>" class="btn btn-primary">
			    				<?
			    			}
			    			?>
			    			Ver Detalles</a>
 			...
 			<div class="card w-90 " >
			   <div class="card-body text-center">
			    ...
			    <div class="container-fluid h-100 d-inline-block ">
			    	<div class="row d-flex align-items-center">
			    		<div class="col-12 card-text text-center numderes m-b-25">
			    			<?= (float)$datosimg["Calidad"]["media"]["num"]  ?>
			    		</div>
			    	</div>
			    </div>
			  </div>
 			...
 			<div class="card w-90 bg-light" >
			   <div class="card-body text-center">
			    <h6 class="card-title titulo d-inline-block h-10">Variación de calidad en la calificación media en <?= $label?></h6>
							...
							<p class="card-text text-center numderes <?= $datosimg["Calidad"]["incremento"]["class"]  ?> "><?= ((float)$datosimg["Calidad"]["incremento"]["num"]<0)?(float)$datosimg["Calidad"]["incremento"]["num"]:(float)$datosimg["Calidad"]["incremento"]["num"]  ?>%</p>
			     ...
			     <div class="container-fluid h-100 d-inline-block ">
			    	<div class="row d-flex align-items-center">
			    		<div class="col-12 card-text text-center numderes ">
			    			<?= (float)$datosimg["Cumplimiento"]["media"]["num"];  ?>
			    		</div>
			    	</div>
			    </div>
 ...
 <div class="container-fluid m-t-20 img-perfil m-b-45">	
	<div class="row d-flex justify-content-center">
		<div class="col-3">
 			<div class="card w-90" >
			   <div class="card-body text-center">
			    <h6 class="card-title titulo  d-inline-block h-10">Calificación Media de oferta en <?= $label?></h6>
			     <div class="container-fluid h-100 d-inline-block ">
			    	<div class="row d-flex align-items-center">
			    		<div class="col-12 card-text text-center numderes ">
			    			<?= $datosimg["Oferta"]["media"]  ?>
			    		</div>
			    	</div>
			    </div>
 		...
 		<div class="col-3">
 			<div class="card w-90 bg-light" >
			   <div class="card-body text-center">
			    <h6 class="card-title titulo ">Variación de oferta en la calificación media en <?= $label?></h6>
					<p class="card-text text-center numderes <?= $datosimg["Oferta"]["incremento"]["class"]?> "><?= ((float)$datosimg["Oferta"]["incremento"]["num"]<0)?(float)$datosimg["Oferta"]["incremento"]["num"]*-1:(float)$datosimg["Oferta"]["incremento"]["num"]?>%</p>		    
			   	<div class="container-fuid p-t-10">
			   		<div class="row">
			   			<div class="col-3 centrar">
			   				<?
			   					if((float)$datosimg["Oferta"]["incremento"]["num"]>0){
			   						?>
			   							<img class="img-fluid" src="<?=base_URL()?>assets/img/iconos/arrow-up-solid-green.svg" alt="">
			   						<?
			   					}else if((float)$datosimg["Oferta"]["incremento"]["num"]<0){
			   						?>
			   						<img class="img-fluid" src="<?=base_URL()?>assets/img/iconos/arrow-down-solid-red.svg" alt="">
			   						<?
			   					}
 ...
 <div class="container-fluid m-b-30">
 	<div class="row">
 		<div class="col-6 text-center text-blue titulos"><h5>Evolución de Número de calificaciones</h5></div>
