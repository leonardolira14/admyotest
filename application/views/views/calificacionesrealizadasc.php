<div class="container margin-top-30">
	<div class="row">
		<div class=" col-12 titulos  text-center margin-bottom-30"><h4><strong>CALIFICACIONES REALIZADAS A CLIENTES</strong></h4></div>
...
<script>
	$(function(){
		...
		ayuda.senddata(obt,"/calificaciones/TotalCalificacionReP",function(data){
						lin=JSON.parse(data);
