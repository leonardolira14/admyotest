...
class Model_Clieprop extends CI_Model{
	...
	public function listaclientes($IDEmpresa){
		...
		foreach ($lis as $proveedor) {
			...
			array_push($listaproveedores,array("num"=>$datos[0]->IDEmpresa,"Razon_Social"=>$datos[0]->Razon_Social,"Nombre_Comer"=>$datos[0]->Nombre_Comer,"RFC"=>$datos[0]->RFC,"Logo"=>$datos[0]->Logo,"Visible"=>"Invisible"));
		}
	...
	public function Resumen($IDEmpresa){
		...
		$serieclientespormes=[["Mes","Numero de Clientes"]];
